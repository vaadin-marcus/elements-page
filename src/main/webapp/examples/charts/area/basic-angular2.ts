...
@Component({
  selector: 'my-area-chart-basic-component',
  template: `
<vaadin-area-chart id="basic-area">
  <chart-title>US and USSR nuclear stockpiles</chart-title>
  ...
  <tooltip point-format="{series.name} produced <b>{point.y}</b><br/>warheads in {point.x}"></tooltip>
  <plot-options>
...
export class MyAreaChartBasicComponent {
