...
@Component({
  selector: 'my-gauge-chart-angular-component',
  template: `
  <vaadin-gauge-chart id="angular-gauge">
  <chart plot-background-color="null" plot-background-image="null" plot-border-width="0" plot-shadow="false"></chart>
  ...
  <pane start-angle="-150" end-angle="150">
    ...
    <background background-color="#DDD" border-width="0" outer-radius="105%" inner-radius="103%">
    </background>
  </pane>
  <y-axis min="0" max="200" minor-tick-interval="auto" minor-tick-width="1" minor-tick-lenght="10" minor-tick-position="inside" tick-pixel-interval="30" tick-width="2" tick-position="inside" tick-length="10" tick-color="#666" grid-line-width="0">
