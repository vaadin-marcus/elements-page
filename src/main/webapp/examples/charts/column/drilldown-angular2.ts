...
@Component({
  selector: 'my-column-chart-drilldown-component',
  template: `
  <vaadin-column-chart class="chart">
    <chart-title>Browser market shares at a specific website, March 2015</chart-title>
...
export class MyColumnChartDrilldownComponent {
