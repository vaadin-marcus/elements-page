...
<style>
  ...
  .board-features .board-code-sample-section__item {
    flex: 0 1 50%;
  }
...
<p>The vaadin-board is divided into rows using vaadin-board-row. You can use any Web Components or HTML elements within a row. Sizing, layouting and wrapping is automatic.</p>
<div class="board-code-sample-section">
  <div class="board-code-sample-section__item">
    <div class="code-container"><pre><code class="language-markup">&lt;vaadin-board&gt;
  &lt;vaadin-board-row&gt;
    &lt;div&gt;1&lt;/div&gt;
    &lt;div&gt;2&lt;/div&gt;
    &lt;div&gt;3&lt;/div&gt;
...
<div class="board-code-sample-section">
  ...
  &lt;vaadin-board-row&gt;
    &lt;div&gt;1&lt;/div&gt;
    &lt;div&gt;2&lt;/div&gt;
    <span class="hl">&lt;vaadin-board-row&gt;</span>
      <span class="hl">&lt;div&gt;3A&lt;/div&gt;</span>
      <span class="hl">&lt;div&gt;3B&lt;/div&gt;</span>
    <span class="hl">&lt;/vaadin-board-row&gt;</span>
  &lt;/vaadin-board-row&gt;
  &lt;vaadin-board-row&gt;
    &lt;div&gt;4&lt;/div&gt;
...
<div class="board-code-sample-section">
  ...
  &lt;/vaadin-board-row&gt;
  &lt;vaadin-board-row&gt;
    &lt;div <span class="hl">board-cols="2"</span>&gt;4&lt;/div&gt;
    &lt;div&gt;5&lt;/div&gt;
  &lt;/vaadin-board-row&gt;
&lt;/vaadin-board&gt;</code></pre></div>
  </div>
...
<script>
  document.querySelectorAll('.language-markup')
