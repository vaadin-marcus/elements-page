...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/elements.css?18" media="screen" charset="utf-8" async>
<link rel="import" href="<%=request.getContextPath()%>/all-the-things_html.html?20" async>
