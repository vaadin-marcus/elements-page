...
<%PortalUtil.setPageTitle("Flag Chart for Polymer, Angular 2, HTML5 | Vaadin Elements", request);%>
...
<div class="w-wallpaper-container elements-hero-mini">
  ...
  <h1 class="helvetica-light">&lt;vaadin-flags-chart&gt;
  </h1>
...
<div class="w-wallpaper-container elements-intro">
  ...
  <div class="row-fluid">
    <div class="span7">
      <p class="lead helvetica-light">A flag chart allows you to flag points on the timeline and axis.</p>
    </div>
...
<!-- Demo section start -->
<%request.setAttribute("chart", "vaadin-flags-chart.html");%>
  ...
  <div class="elements-section">
    ...
    <demo-viewer selected="{{selected}}">
      ...
      <vaadin-flags-chart id="flags-placement" timeline>
        ...
        <data-series name="Flags on series" draw-on-series="dataseries" shape="squarepin">
          <data>
            <point>
              <x>1430438400000</x>
              <chart-title>On series</chart-title>
            </point>
            <point>
              <x>1433030400000</x>
              <chart-title>On series</chart-title>
        ...
        <data-series name="Flags on axis" shape="squarepin">
          <data>
            <point>
              <x>1431734400000</x>
              <chart-title>On axis</chart-title>
            </point>
            <point>
              <x>1434326400000</x>
              <chart-title>On axis</chart-title>
        ...
        <data-series type="line" name="USD to EUR" id="dataseries">
