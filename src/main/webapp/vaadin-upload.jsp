...
<%PortalUtil.setPageTitle("Upload web component for HTML and JS frameworks | Vaadin Elements", request);%>
...
<template is="dom-bind" id="dynamicDataTemplate">
  <div class="w-wallpaper-container zebra elements-dynamic-content">
     <div class="top-navigation">
       ...
       <a href="https://github.com/vaadin/vaadin-upload" class="try-out-link" target="_blank">
         <div class="try-out">
           Github
       ...
       <a href="https://jsbin.com/necosow/2/edit?html,output" class="try-out-link" target="_blank">
         <div class="try-out">
           Try it out
           <svg fill="#555" height="12" viewBox="0 0 24 24" width="12" xmlns="http://www.w3.org/2000/svg">
             <path d="M0 0h24v24H0z" fill="none"/>
       ...
       <div class="flexchild">
         <iron-pages attr-for-selected="data-nav" selected="{{selectedNavItem}}" fallback-selection="demos">
           <div data-nav="demos" id="demo_content" class="demos-list">
             <iframe src="https://cdn.vaadin.com/vaadin-upload/2.0.0/demo/" frameborder="0" scrolling="no" class="element-demo-iframe" onload="setIframeResize()"></iframe>
           </div>
           <div data-nav="docs">
             <vaadin-component-page src="https://cdn.rawgit.com/vaadin/vaadin-upload/v2.0.0/vaadin-upload.html"></vaadin-component-page>
           </div>
